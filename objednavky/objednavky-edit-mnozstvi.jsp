...
if (session.getAttribute("loginFlag")!=null) {
	try {
	    ...
	    orderID = Integer.parseInt(request.getParameter("orderIDBox"));
		productID = Integer.parseInt(request.getParameter("productIDBox"));
		//change = Double.parseDouble(request.getParameter("changeBox"));
		
	  	///ošetření čárky
	   	try {
	   		if (request.getParameter("changeBox").contains(",")) {
	   			valueConvert = request.getParameter("changeBox").split(",");
