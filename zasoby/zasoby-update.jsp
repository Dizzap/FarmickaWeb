...
if (session.getAttribute("loginFlag")!=null) {
	try {
	    ...
	    ///ošetření prázné objednávky
	    for (int i=0;i < productStock.length;i++){
	    	productAdd = productAdd+formValues[i];
	    }
	    
	    if(productAdd==0 || dotCheck==true){
	    	out.println("<b>Chybný vstup</b>");
	    } else {
		    ...
		    ///konfirmace
		    out.println("byla v pořádku zavedena do systému. </b><br/>");
	    }
